...
- 官网气质：偏创意品牌、游戏感和视觉冲击，参考 Apple 官网的克制文案、大幅视觉、清晰节奏和强产品呈现
...
- `/mascot`：虚拟形象页面，展示原始萝卜、儿童形态和成熟少女形态。
...
虚拟形象素材已整理到 `assets/avatars/`：

- `origin/`：原始萝卜。
- `child/`：可爱的儿童萝卜形态、设定图、站姿、表情包和服装变体。
- `mature/`：成熟少女萝卜形态、设定图、站姿和表情包。
...
节日素材不建议作为官网长期主视觉，更适合作为活动 Banner 或节日彩蛋。官网长期主视觉更适合从 `child/` 和 `mature/` 的设定图、站姿图中挑选。
...
- 许可证和版权口径：确认官网代码、图片素材和项目介绍内容的版权说明。
...
等页面方向确认后，再开始创建前端项目、初始化 Git、配置 Vercel 和 GitHub 仓库。
