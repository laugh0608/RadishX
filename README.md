...
- 家族 UI 规范：`docs/design/family-ui/` 是服务整个 Radish 家族的统一 UI / 视觉规范（family-ui v1.0.0），官网作为 Brand 展示面继承其通用口径；各兄弟项目未来按 `family-ui/10-migration-playbook.md` 撤除各自通用 UI 专题并接入本规范
