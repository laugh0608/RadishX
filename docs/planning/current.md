...
| 目标 | 文档 | 当前状态 |
| --- | --- | --- |
| 首页首屏与主视觉 | [home-hero-visual.md](../features/home-hero-visual.md) | 站姿中心视觉锚点已接入，OG 待后续评估 |
...
2. 根据站姿图接入后的首页首屏气质，后续再评估是否替换当前 Open Graph 分享预览图。
3. 继续评估 Mascot 表情拆分、节日图和下载口径；没有确认边界前不提供下载入口。
...
- 首页站姿中心视觉接入后的 Open Graph 图是否需要替换。
...
2. 根据首页站姿中心视觉的实际呈现，后续评估是否替换当前 Open Graph 分享预览图。
3. 继续评估 Mascot 表情拆分、节日图和下载口径；确认前不提供下载入口。
