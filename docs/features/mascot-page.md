...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `rx-expression-001` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R1C1` | 开心 | happy | `happy` | `internal-preview` | Mascot 页面单张表情基础情绪候选。 | 保留双手、表情符号和中文标签；不作为下载素材。 | `public/images/mascot/expressions/radish-child-expression-happy-web.jpg` | `public/images/mascot/expressions/radish-child-expression-happy-thumb.jpg` | 已生成 Web 展示图。 |
| `rx-expression-002` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R1C2` | 生气 | angry | `angry` | `internal-preview` | 用于状态反馈或轻量情绪说明候选。 | 保留头顶怒气符号和手臂姿态；不做攻击性语境延展。 | `public/images/mascot/expressions/radish-child-expression-angry-web.jpg` | `public/images/mascot/expressions/radish-child-expression-angry-thumb.jpg` | 已生成 Web 展示图。 |
| `rx-expression-003` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R1C3` | 震惊 | surprised | `surprised` | `internal-preview` | 用于异常、惊讶或提示类轻量插图候选。 | 保留双手、眼睛和惊叹符号；不裁掉上方符号。 | `public/images/mascot/expressions/radish-child-expression-surprised-web.jpg` | `public/images/mascot/expressions/radish-child-expression-surprised-thumb.jpg` | 已生成 Web 展示图。 |
| `rx-expression-004` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R2C3` | 得意 | proud | `proud` | `internal-preview` | 用于完成、亮点或正向反馈候选。 | 保留眨眼、手势和星形符号；不替代正式品牌 Logo。 | `public/images/mascot/expressions/radish-child-expression-proud-web.jpg` | `public/images/mascot/expressions/radish-child-expression-proud-thumb.jpg` | 已生成 Web 展示图。 |
| `rx-expression-005` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R2C4` | 期待 | expectant | `expectant` | `internal-preview` | 用于待办、预告或轻量引导候选。 | 保留双手和星形符号；不写成上线承诺。 | `public/images/mascot/expressions/radish-child-expression-expectant-web.jpg` | `public/images/mascot/expressions/radish-child-expression-expectant-thumb.jpg` | 已生成 Web 展示图。 |
| `rx-expression-006` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R3C2` | 疑问 | question | `question` | `internal-preview` | 用于 FAQ、待确认事项或说明提示候选。 | 保留问号符号和手势；不脱离上下文暗示错误。 | `public/images/mascot/expressions/radish-child-expression-question-web.jpg` | `public/images/mascot/expressions/radish-child-expression-question-thumb.jpg` | 已生成 Web 展示图。 |
| `rx-expression-007` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R3C3` | 无语 | speechless | `speechless` | `internal-preview` | 用于轻量空状态或非阻断提示候选。 | 保留省略号，不用于嘲讽用户或错误归因。 | `public/images/mascot/expressions/radish-child-expression-speechless-web.jpg` | `public/images/mascot/expressions/radish-child-expression-speechless-thumb.jpg` | 已生成 Web 展示图。 |
| `rx-expression-008` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R5C2` | OK | ok | `ok` | `internal-preview` | 用于完成状态、确认或轻量成功反馈。 | 保留手势和 `OK` 字样；不作为独立授权图标。 | `public/images/mascot/expressions/radish-child-expression-ok-web.jpg` | `public/images/mascot/expressions/radish-child-expression-ok-thumb.jpg` | 已生成 Web 展示图。 |
| `rx-expression-009` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R5C3` | 加油 | cheer | `cheer` | `internal-preview` | 用于项目进展、开发日志或鼓励类提示。 | 保留举拳和强调线；不用于商业承诺或进度承诺。 | `public/images/mascot/expressions/radish-child-expression-cheer-web.jpg` | `public/images/mascot/expressions/radish-child-expression-cheer-thumb.jpg` | 已生成 Web 展示图。 |
| `rx-expression-010` | `assets/avatars/child/radish-child-expression-sheet-grid.png` | `R6C4` | 再见 | goodbye | `goodbye` | `internal-preview` | 用于页尾彩蛋、404 辅助或结束状态。 | 保留挥手和红色强调线；不作为可下载贴纸。 | `public/images/mascot/expressions/radish-child-expression-goodbye-web.jpg` | `public/images/mascot/expressions/radish-child-expression-goodbye-thumb.jpg` | 已生成 Web 展示图。 |
