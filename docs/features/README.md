...
| [visual-qa-and-release.md](visual-qa-and-release.md) | 本地 / 线上视觉 QA、构建和发布检查 | 本地质量基线收束、HTTP smoke、实现口径对齐、设计源同步、Mascot Chrome smoke 和线上 HTTP smoke 已完成，线上截图级 smoke 待补 |
