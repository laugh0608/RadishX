...
4. 已使用 Pencil `snapshot_layout` 检查布局问题。
5. 已抽查关键画板截图，确认无裁切、重叠或明显旧口径。
6. 已更新本文件、`docs/planning/current.md` 和本周开发日志。
...
- v1.1 画板覆盖首页桌面、首页移动、项目详情模板、Mascot 页和 About 页。
...
- 如 React 页面后续大幅调整，再回到 v1.1 设计源同步结构。
- 如新增正式 Logo、真实截图、视频或 seasonal 活动，再单独更新对应目标文档和设计源。
- 项目详情模板、Mascot 页和 About 页本轮只补桌面精确稿；如后续需要设计阶段覆盖移动端细节，再单独新增移动版画板。
